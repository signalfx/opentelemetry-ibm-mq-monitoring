...
public class Metrics {
  ...
  public static LongUpDownCounter createMqMessageRetryCount(Meter meter) {
    return meter.upDownCounterBuilder("mq.message.retry.count").setUnit("{messages}").setDescription("Number of message retries").build();
  }
  ...
  public static LongUpDownCounter createMqByteReceived(Meter meter) {
    return meter.upDownCounterBuilder("mq.byte.received").setUnit("{bytes}").setDescription("Number of bytes received").build();
  }

  public static LongUpDownCounter createMqByteSent(Meter meter) {
    return meter.upDownCounterBuilder("mq.byte.sent").setUnit("{bytes}").setDescription("Number of bytes sent").build();
  }

  public static LongUpDownCounter createMqBuffersReceived(Meter meter) {
    return meter.upDownCounterBuilder("mq.buffers.received").setUnit("{buffers}").setDescription("Buffers received").build();
  }

  public static LongUpDownCounter createMqBuffersSent(Meter meter) {
    return meter.upDownCounterBuilder("mq.buffers.sent").setUnit("{buffers}").setDescription("Buffers sent").build();
  }

  public static LongUpDownCounter createMqMessageCount(Meter meter) {
    return meter.upDownCounterBuilder("mq.message.count").setUnit("{messages}").setDescription("Message count").build();
  }
  ...
  public static LongUpDownCounter createMqMessageDeqCount(Meter meter) {
    return meter.upDownCounterBuilder("mq.message.deq.count").setUnit("{messages}").setDescription("Message dequeue count").build();
  }

  public static LongUpDownCounter createMqMessageEnqCount(Meter meter) {
    return meter.upDownCounterBuilder("mq.message.enq.count").setUnit("{messages}").setDescription("Message enqueue count").build();
  }
  ...
  public static LongUpDownCounter createMqMessageReceivedCount(Meter meter) {
    return meter.upDownCounterBuilder("mq.message.received.count").setUnit("{messages}").setDescription("Number of messages received").build();
  }

  public static LongUpDownCounter createMqMessageSentCount(Meter meter) {
    return meter.upDownCounterBuilder("mq.message.sent.count").setUnit("{messages}").setDescription("Number of messages sent").build();
  }
